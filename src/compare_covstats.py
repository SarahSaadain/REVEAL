...
Usage
-----
    REVEAL covcompare --stats s1.covstats.tsv s2.covstats.tsv --cn-fc 1.0 --cn-abs 10

    REVEAL covcompare --stats *.covstats.tsv --cn-fc 1.0 --cn-abs 10 --outfile results.tsv

    # only show flagged sequences in terminal and output
    REVEAL covcompare --stats *.covstats.tsv --cn-fc 1.0 --cn-abs 10 --flagged-only
